...
def seed_photos():
  Photo1 = Photo(
    user_id=1, album_id=1, url=random.choice(photos), title='Photo1', description='description1', preview_img=True, favorite_count=random.randint(1, 30)
  )
  Photo2 = Photo(
    user_id=2, album_id=2, url=random.choice(photos), title='Photo2', description='description2', preview_img=True, favorite_count=random.randint(1, 30)
  )
  Photo3 = Photo(
    user_id=3, album_id=3, url=random.choice(photos), title='Photo3', description='description3', preview_img=True, favorite_count=random.randint(1, 30)
  )
  Photo4 = Photo(
  ...
  Photo6 = Photo(
    user_id=6, album_id=2, url=random.choice(photos), title='Photo6', description='description6', favorite_count=random.randint(1, 30)
  )
  Photo7 = Photo(
    user_id=7, album_id=3, url=random.choice(photos), title='Photo7', description='description7', favorite_count=random.randint(1, 30)
  )
  Photo8 = Photo(
    user_id=1, album_id=4, url=random.choice(photos), title='Photo8', description='description8', favorite_count=random.randint(1, 30)
  )
  Photo9 = Photo(
    user_id=2, album_id=5, url=random.choice(photos), title='Photo9', description='description9', favorite_count=random.randint(1, 30)
  )
  Photo10 = Photo(
    user_id=3, album_id=1, url=random.choice(photos), title='Photo10', description='description10', favorite_count=random.randint(1, 30)
  )
  Photo11 = Photo(
    user_id=4, album_id=2, url=random.choice(photos), title='Photo11', description='description11', favorite_count=random.randint(1, 30)
  )
  Photo12 = Photo(
    user_id=5, album_id=3, url=random.choice(photos), title='Photo12', description='description12', favorite_count=random.randint(1, 30)
  )
  Photo13 = Photo(
    user_id=6, album_id=4, url=random.choice(photos), title='Photo13', description='description13', favorite_count=random.randint(1, 30)
  )
  Photo14 = Photo(
    user_id=7, album_id=5, url=random.choice(photos), title='Photo14', description='description14', favorite_count=random.randint(1, 30)
  )
  Photo15 = Photo(
    user_id=1, album_id=1, url=random.choice(photos), title='Photo15', description='description15', favorite_count=random.randint(1, 30)
  )
